...
public class UrlController {
    ...
    private static String Purchase_code = "Enter the purchase code here";//Enter the purchase code here
    private static String Custom_Security = "Enter the Custom Security code here";//Enter the Custom Security code here
    private static String IP_ADDRESS = "Enter You Ip_Address here here";//Enter You Ip_Address here here
