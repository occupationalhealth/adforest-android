...
add_action('plugins_loaded', 'adforest_switch_lang_api_callback');
...
function adforest_switch_lang_api_callback() {
    ...
    if (function_exists('icl_object_id')) {
        ...
        if (apply_filters('wpml_is_rtl', NULL)) {
            $adforest_api_options['app_settings_rtl'] = '1'; // use to set default text direction of site
        } else {
            $adforest_api_options['app_settings_rtl'] = '0'; // use to set default text direction of site
        }
        update_option($opt_name, $adforest_api_options);
    }
}
